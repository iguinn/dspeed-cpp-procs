...
add_ufunc_impl(pole_zero_f, (pole_zero<float, Aligned>), (pole_zero<float, Unaligned>), "(n),()->(n)" )
add_ufunc_impl(pole_zero_d, (pole_zero<double, Aligned>), (pole_zero<double, Unaligned>), "(n),()->(n)" )
create_ufunc(pole_zero_ufunc, "pole_zero", pole_zero_doc, pole_zero_f, pole_zero_d)
