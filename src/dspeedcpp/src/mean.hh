...
add_ufunc_impl(mean_f, (mean<float, Aligned>), (mean<float, Unaligned>), "(n)->()" )
add_ufunc_impl(mean_d, (mean<double, Aligned>), (mean<double, Unaligned>), "(n)->()" )
create_ufunc(mean_ufunc, "mean", mean_doc, mean_f, mean_d)
